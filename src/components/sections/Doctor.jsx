...
const credentials = [
  ...
  ['robot', 'Cirurgia Robótica', 'Abordagem minimamente\ninvasiva com tecnologia\navançada.'],
...
export default function Doctor() {
  return (
    <section className="doctor-section" id="especialista" data-track-section="doctor">
      <div className="doctor-photo-panel">
      ...
      <div className="doctor-content">
        <h2><TextLines text={'EXPERIÊNCIA E CREDIBILIDADE\nPARA CUIDAR COM EXCELÊNCIA'} /></h2>
